...
Given a set of features $\mathbf{X} = \{ x_1, x_2, ..., x_i \}$ and set of target classes $\mathbf{C} = \small\brace{ c_1, c_2, ..., c_k }$, we can begin constructing a Naive Bayes classifier.
